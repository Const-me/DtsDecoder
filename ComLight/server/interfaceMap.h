...
#define BEGIN_COMLIGHT_MAP()                                      \
protected:                                                   \
bool implQueryInterface( REFIID iid, void** ppvObject ) {

#define END_COMLIGHT_MAP() return false; }
...
#define COMLIGHT_INTERFACE_ENTRY( I ) if( ComLight::details::tryReturnInterface<I>( iid, this, ppvObject ) ) return true;